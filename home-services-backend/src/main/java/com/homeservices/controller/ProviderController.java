...
public class ProviderController {
    ...
    public ResponseEntity<ApiResponse<ProviderServiceResponse>> updateService(
            @PathVariable UUID id, @Valid @RequestBody ProviderServiceRequest request) {
        return ResponseEntity.ok(ApiResponse.success(
    ...
    public ResponseEntity<ApiResponse<ProviderResponse>> toggleActive(@RequestParam boolean active) {
        ProviderResponse res = providerManagementService.toggleActive(securityUtil.getCurrentUserId(), active);
    ...
    public ResponseEntity<ApiResponse<List<ProviderAvailabilityResponse>>> getMyAvailability() {
        return ResponseEntity.ok(ApiResponse.success(
                providerManagementService.getMyAvailability(securityUtil.getCurrentUserId())));
    }
    ...
    public ResponseEntity<ApiResponse<BookingResponse>> updateBookingStatus(
            @PathVariable UUID id, @Valid @RequestBody BookingStatusRequest request) {
        return ResponseEntity.ok(ApiResponse.success(
    ...
    public ResponseEntity<ApiResponse<ProviderDetailResponse>> uploadDocuments(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                providerManagementService.uploadDocuments(
